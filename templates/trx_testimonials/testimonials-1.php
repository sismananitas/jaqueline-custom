...
if ( !function_exists( 'jacqueline_template_testimonials_1_theme_setup' ) ) {
	add_action( 'jacqueline_action_before_init_theme', 'jacqueline_template_testimonials_1_theme_setup', 1 );
	function jacqueline_template_testimonials_1_theme_setup() {
		jacqueline_add_template(array(
			'layout' => 'testimonials-1',
			'template' => 'testimonials-1',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 1/', 'jacqueline'),
...
// Template output
if ( !function_exists( 'jacqueline_template_testimonials_1_output' ) ) {
	function jacqueline_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
